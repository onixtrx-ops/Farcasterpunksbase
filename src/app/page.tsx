    ...
    <main style={{
      ...
      <div style={{maxWidth:900, width:"100%", background:"rgba(255,255,255,0.03)", padding:28, borderRadius:14}}>
        <div style={{display:"flex", gap:18, alignItems:"center"}}>
          <img src="/public/assets/logo.png" style={{width:120, height:120, borderRadius:12}} alt="logo" />
          <div>
        ...
        <div style={{display:"flex", gap:24, marginTop:20, flexWrap:"wrap"}}>
          ...
          <div style={{width:260}}>
            <img src="/public/assets/logo.png" style={{width:"100%", borderRadius:12}} alt="preview" />
          </div>
        </div>
      </div>
    </main>
